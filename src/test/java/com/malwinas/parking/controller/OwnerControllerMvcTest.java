...
public class OwnerControllerMvcTest {
	...
	public void getProfitTest() throws Exception {
		...
		Assert.assertEquals(9.0, new BigDecimal(response).doubleValue(), Math.pow(10, -2));
	}
	...
	public void getNoProfitTest() throws Exception {
		...
		Assert.assertEquals(0.0, new BigDecimal(response).doubleValue(), Math.pow(10, -2));
	}
	...
	private Collection<Ticket> getTickets() {
		...
		firstTicket.setId(Long.valueOf(1));
		firstTicket.setEndTime(firstEndTime);
		firstTicket.setCharge(new BigDecimal(7.0));
		...
		secondTicket.setId(Long.valueOf(2));
		secondTicket.setEndTime(secondEndTime);
		secondTicket.setCharge(new BigDecimal(2.0));
